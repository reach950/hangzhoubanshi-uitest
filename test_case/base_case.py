...
from page_object.main.ai_customer_service_page import AICustomerServicePage
from page_object.main.guide_subpages.guide_select_page import GuideSelectPage
from page_object.main.guide_subpages.personal_or_legal_guide_list_page import PersonalOrLegalGuideListPage
from page_object.main.guide_subpages.guide_detail_page import GuideDetailPage
from page_object.main.search_page import SearchPage
from page_object.main.all_apps_page import AllAppsPage
from page_object.main.reserve_subpages.handle_page import HandlePage
from page_object.main.reserve_subpages.query_page import QueryPage
from page_object.main.reserve_subpages.pay_page import PayPage
from page_object.main.reserve_subpages.reserve_process_subpages.hangzhou_civic_center_page import \
    HangzhouCivicCenterPage
...
from page_object.main.reserve_subpages.reserve_info_query_subpages.reserve_detail_page import ReserveDetailPage
...
from page_object.main.reserve_subpages.reserve_info_query_subpages.how_to_scan_code_page import HowToScanCodePage
from page_object.services.service_detail_page import ServiceDetailPage
from page_object.services.car_quota.car_quota_main_page import CarQuotaMainPage
from page_object.services.education_pay.common_pay_page import CommonPayPage
from page_object.services.medical_insurance.medical_insurance_main_page import MedicalInsuranceMainPage
...
from page_object.main.district_stage_subpages.district_services_main_page import DistrictServicesMainPage
from page_object.main.district_stage_subpages.district_select_page import DistrictSelectPage
from page_object.main.district_stage_subpages.all_departments_page import AllDepartmentsPage
from page_object.main.district_stage_subpages.transportation_bureau_page import TransportationBureauPage
...
class BaseCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.init_page()
        self.main_page.wait_to_display()
    ...
    def init_page(self):
        ...
        self.car_quota_main_page = CarQuotaMainPage(self.driver)
        self.mobile_population_reside_registration_page = MobilePopulationResideRegistrationPage(self.driver)
        self.medical_insurance_main_page = MedicalInsuranceMainPage(self.driver)
        self.common_pay_page = CommonPayPage(self.driver)
        self.district_services_main_page = DistrictServicesMainPage(self.driver)
