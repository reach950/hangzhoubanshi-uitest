...
class TestAllApps(BaseCase):
    ...
    def test_02_search_success(self):
        ...
        self.assertTrue(self.all_apps_page.check_element_by_name(query_search_result))
        self.assertTrue(self.all_apps_page.check_element_by_name(pay_search_result))
